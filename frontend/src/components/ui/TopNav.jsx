        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={onBack}
              className="p-2 -ml-2 text-slate-500 hover:text-slate-700 hover:bg-slate-50 rounded-xl transition-all active:scale-95 border border-transparent hover:border-slate-100"
            >
              <ArrowLeft size={20} className="stroke-2" />
            </button>
            <h1 className="text-base font-bold text-slate-800 font-heading tracking-tight">
              {title}
            </h1>
          </div>
          {rightElement && (
