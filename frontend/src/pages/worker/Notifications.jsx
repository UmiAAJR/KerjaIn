...
export default function WorkerNotification() {
  ...
  const filteredNotification = NotificationData.filter((n) => {
    ...
    return n.status === notificationTab;
  })
          ...
          {filteredNotification.map((n) => (
            ...
            <div
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                />
                <div>
                  <h3 className="font-bold text-slate-900 text-base">{n.name}</h3>
                  <p className="text-xs text-slate-500 font-medium">{n.bookingDate} • {n.startedAt}</p>
                </div>
              </div>
