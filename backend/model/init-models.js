...
export default function initModels(sequelize) {
  ...
  const History = _History.init(sequelize, DataTypes);
  ...
  Panic.belongsTo(History, { as: "History", foreignKey: "HistoryID"});
  History.hasMany(Panic, { as: "panics", foreignKey: "HistoryID"});
  Panic.belongsTo(Job, { as: "Job", foreignKey: "JobID"});
  Job.hasMany(Panic, { as: "panics", foreignKey: "JobID"});
  History.belongsTo(Payment, { as: "Payment", foreignKey: "PaymentID"});
  Payment.hasMany(History, { as: "histories", foreignKey: "PaymentID"});
  Job.belongsTo(Payment, { as: "Payment", foreignKey: "PaymentID"});
  Payment.hasMany(Job, { as: "jobs", foreignKey: "PaymentID"});
  WorkerSkill.belongsTo(Skill, { as: "Skill", foreignKey: "SkillID"});
  Skill.hasMany(WorkerSkill, { as: "worker_skills", foreignKey: "SkillID"});
  History.belongsTo(User, { as: "Client", foreignKey: "ClientID"});
  User.hasMany(History, { as: "histories", foreignKey: "ClientID"});
  Job.belongsTo(User, { as: "Client", foreignKey: "ClientID"});
  User.hasMany(Job, { as: "jobs", foreignKey: "ClientID"});
  Worker.belongsTo(User, { as: "User", foreignKey: "UserID"});
  User.hasMany(Worker, { as: "workers", foreignKey: "UserID"});
  History.belongsTo(Worker, { as: "Worker", foreignKey: "WorkerID"});
  Worker.hasMany(History, { as: "histories", foreignKey: "WorkerID"});
  Job.belongsTo(Worker, { as: "Worker", foreignKey: "WorkerID"});
  Worker.hasMany(Job, { as: "jobs", foreignKey: "WorkerID"});
  Verify.belongsTo(Worker, { as: "Worker", foreignKey: "WorkerID"});
  Worker.hasMany(Verify, { as: "verifies", foreignKey: "WorkerID"});
  WorkerSkill.belongsTo(Worker, { as: "Worker", foreignKey: "WorkerID"});
  Worker.hasMany(WorkerSkill, { as: "worker_skills", foreignKey: "WorkerID"});
